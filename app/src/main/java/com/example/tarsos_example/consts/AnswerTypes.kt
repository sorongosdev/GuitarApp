...
//        DELETED to (Color.Gray)
        BEAT_W_CHORD_X to (Color.Transparent),       // 박자 X 코드 미정
        BEAT_C_CHORD_X to (Color.Transparent),     // 박자 0 코드 미정
        BEAT_W_CHORD_C to (Color.Green),      // 박자 X 코드 0
        BEAT_W_CHORD_W to (Color.Red),      // 박자 X 코드 X
        BEAT_C_CHORD_C to (Color.Green),   // 박자 0 코드 0
        BEAT_C_CHORD_W to (Color.Red),     // 박자 0 코드 X
